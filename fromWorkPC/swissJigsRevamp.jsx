...
const knifeFormFactors = {
    ...
    "84 mm - Front": {
        ...
        "coordinates": {
            "text" : {
                ...
                "bottomRight": [161.1, 136.2],
                "topRight": [161.634, 17.533]
            },
            "outline" : {
                "bottomLeft": [7.2, 136.0],
                "bottomRight": [107.2, 136.2],
                "topRight": [107.734, 17.533]
            },
            "crest" : {
                "bottomLeft": [25.2, 136.0],
                "bottomRight": [125.2, 136.2],
                "topRight": [125.7, 17.533]
            }
        },
        "jigRows": 5,
        "jigColumns": 2,
    ...
    "65 mm - Front ": {
        ...
        "coordinates": {
            "text" : {
                ...
                "topRight": [120.62, 13.15]
            },
            "outline" : {
                "bottomLeft": [5.1, 139.5],
                "bottomRight": [78.2, 139.5],
                "topRight": [79.22, 13.15]
            },
            "crest" : {
                "bottomLeft": [19.6, 139.5],
                "bottomRight": [92.7, 139.5],
                "topRight": [93.7, 13.15]
            }
        },
        "jigRows": 7,
        "jigColumns": 2,
        "crestScale" : 0.78260869565,
        "preset": { text: "", font: "Script", color: "White", primer: true },
    },
    "58 mm - Front": {
        "inverted": false,
        ...
        "coordinates": {
            ...
            "crest" : {
                "bottomLeft": [18.7, 139.4],
                "bottomRight": [151.3, 139.6],
                "topRight": [151.78, 12.88]
            }       
        },
        "jigRows": 7,
        "jigColumns": 3,
    ...
    "58 mm - Back": {
        ...
        "coordinates": {
            "text" : {
                "bottomLeft": [34.3, 139.4],
                "bottomRight": [166.9, 139.6],
                "topRight": [167.3, 12.88]
            },
            "outline" : {
                "bottomLeft": [4.9, 139.4],
                "bottomRight": [137.5, 139.6],
